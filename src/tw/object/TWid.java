...
// Ovetload 覆載  方法名稱一樣 參數型別不一樣
public class TWid {
	private String id;
	private static String letters = "ABCDEFGHJKLMNPQRSTUVWXYZIO";
	...
	public String getLocation() {
	 ...
	 public static TWid craeteTWid(String id) throws Exception {
		 if (isRightID(id)) {
			 return new TWid(id);
		 }else {
//			 return null;  
			 throw new Exception("ID ERRR");
		 }
	 }
